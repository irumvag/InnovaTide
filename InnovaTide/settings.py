"""
Django settings for InnovaTide project.
...
SECRET_KEY = 'django-insecure-$ihp^!(r)=wqoorea8eh_(rx#w)0vq%-e1o)j)z7t#^fygpk^1'
...
WSGI_APPLICATION = 'InnovaTide.wsgi.application'
